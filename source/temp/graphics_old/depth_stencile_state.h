...
class DepthStencileState : public SmartPointerObject<DepthStencileState>,
                           public FastPImpl {
    friend class Device;

private:
    static SPtr create(NativeHandle device, DepthStencileFunc depth_func,
                       DepthStencileFunc stencile_func);

    DepthStencileState(NativeHandle device, DepthStencileFunc depth_func,
                       DepthStencileFunc stencile_func);
