...
Vector3Base< T > Vector3Base< T >::operator+(const Vector3Base< T > &rhs) {
    return Vector3Base< T >(elements_[0] + rhs.elements_[0], elements_[1] + rhs.elements_[1], elements_[2] + rhs.elements_[2]);
}
...
Vector3Base< T > operator*(Float32 lhs, const Vector3Base< T > &rhs) {
    return Vector3Base< T >(lhs * rhs.elements_[0], lhs * rhs.elements_[1], lhs * rhs.elements_[2]);
}
...
Vector3Base< T > operator*(const Vector3Base< T > &lhs, const Vector3Base< T > &rhs) {
    return Vector3Base< T >(lhs.x() * rhs.x(), lhs.y() * rhs.y(), lhs.z() * rhs.z());
}

template < typename T >
Vector3Base< T > operator/(const Vector3Base< T > &lhs, Float32 rhs) {
    return Vector3Base< T >(lhs.elements_[0] / rhs, lhs.elements_[1] / rhs, lhs.elements_[2] / rhs);
}

template < typename T >
Float32 Vector3Base< T >::angle(const Vector3Base< T > &lhs, const Vector3Base< T > &rhs) {
    return acos(dot(lhs, rhs) / sqrt(lhs.lengthSquared() * rhs.lengthSquared()));
}

template < typename T >
Vector3Base< T > Vector3Base< T >::cross(const Vector3Base< T > &lhs, const Vector3Base< T > &rhs) {
    auto a0 = lhs.yzx();
    auto b0 = rhs.zxy();
    auto a1 = lhs.zxy();
    auto b1 = rhs.yzx();
...
template < typename T >
Float32 Vector3Base< T >::distance(const Vector3Base &lhs, const Vector3Base &rhs) {
...
Vector4Base< T > Vector4Base< T >::operator+(const Vector4Base< T > &rhs) {
    return Vector4Base< T >(x() + rhs.x(), y() + rhs.y(), z() + rhs.z(), w() + rhs.w());
}
...
Vector4Base< T > operator*(Float32 lhs, const Vector4Base< T > &rhs) {
    return Vector4Base< T >(lhs * rhs.x(), lhs * rhs.y(), lhs * rhs.z(), lhs * rhs.w());
}
...
Vector4Base< T > operator*(const Vector4Base< T > &lhs, const Vector4Base< T > &rhs) {
    return Vector4Base< T >(lhs.x() * rhs.x(), lhs.y() * rhs.y(), lhs.z() * rhs.z(), lhs.w() * rhs.w());
}
