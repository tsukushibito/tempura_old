...
IndexBuffer::SPtr IndexBuffer::create(NativeHandle device, Size size, const void *data) {
    struct Creator : public IndexBuffer {
        Creator(NativeHandle device, Size size, const void *data) : IndexBuffer(device, size, data) {}
    };
