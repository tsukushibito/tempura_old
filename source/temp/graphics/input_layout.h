...
private:
    static SPtr create(NativeHandle device, const InputElementDesc element_descs[], UInt32 element_count);

    InputLayout(NativeHandle device, const InputElementDesc element_descs[], UInt32 element_count);
