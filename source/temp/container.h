...
// std::string
using String = std::basic_string< char, std::char_traits< char >, allocator::AllocatorForSTL< char > >;
...
using Map = std::map< Key, Type, Compare, allocator::AllocatorForSTL< std::pair< const Key, Type > > >;

// std::unordered_map<Key, Type>
template < typename Key, typename Type, typename Hash = std::hash< Key >, typename Pred = std::equal_to< Key > >
using HashMap = std::unordered_map< Key, Type, Hash, Pred, allocator::AllocatorForSTL< std::pair< const Key, Type > > >;
