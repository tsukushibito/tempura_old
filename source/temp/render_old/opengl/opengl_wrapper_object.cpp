...
void VertexArrayObject::setVertexBuffer(VertexAttribute         attribute,
    ...
    if (vertex_buffer == nullptr) {
        ...
        switch (desc.format) {
        case temp::graphics_::VertexBufferFormat::kUInt8x4:
            size = 4;
            type = GL_UNSIGNED_BYTE;
            break;
        case temp::graphics_::VertexBufferFormat::kFloat16x2:
            size = 2;
            type = GL_HALF_FLOAT;
            break;
        case temp::graphics_::VertexBufferFormat::kFloat16x4:
            size = 4;
            type = GL_HALF_FLOAT;
            break;
        case temp::graphics_::VertexBufferFormat::kFloat32x2:
            size = 2;
            type = GL_FLOAT;
            break;
        case temp::graphics_::VertexBufferFormat::kFloat32x4:
            size = 4;
            type = GL_FLOAT;
            break;
        default:
